...
create_table_query1 = """CREATE TABLE IF NOT EXISTS query1 (session_id TEXT, 
item_in_session TEXT, artist TEXT, song TEXT, length TEXT, PRIMARY KEY (
session_id, item_in_session))"""

create_table_query2 = """CREATE TABLE IF NOT EXISTS query2 (user_id TEXT, 
...
insert_table_query2 = """INSERT INTO query2 (user_id, session_id, 
